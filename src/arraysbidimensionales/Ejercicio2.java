...
/**
 * Clase donde se realizara el ejercicio 2 que consite en hacer una serie de
...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < NUM_ALUMNOS; i++) {
			...
			// Bucle para ir preguntando las notas por cada asignatura e introducirlas en la
			// tabla notas
		...
		// Bucle para calcular la nota min, la max, y la media de estas
		for (int i = 0; i < NUM_ALUMNOS; i++) {
